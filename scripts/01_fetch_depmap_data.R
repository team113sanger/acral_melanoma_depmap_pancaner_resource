...
# Fetch the Avana raw counts file from figshare
curl::curl_download("https://figshare.com/ndownloader/files/51064568", 
                    destfile = here("data", "AvanaRawReadcounts.csv"))
...
curl::curl_download("https://figshare.com/ndownloader/files/51065828", 
                    destfile = here("data", "ScreenSequenceMap.csv"))
